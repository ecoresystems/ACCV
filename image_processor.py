...
# DCT and IDCT realized in matrix multiplication method (CPU)
...
def quantizer(block, quantization_matrix):
    return np.round(block / quantization_matrix.reshape(8, 8)).astype(dtype="int16")


# Scipy built-in dct transformation
def dct2(a):
